...
func (r *IndexTemplateReconciler) equal(request *requests.IndexTemplate, response *responses.IndexTemplate) bool {
	...
	logger.Info(fmt.Sprintf("Template.Settings string new: %s", request.Template.Settings.String()))
	logger.Info(fmt.Sprintf("Template.Settings string existing: %s", response.IndexTemplate.Template.Settings.String()))
	logger.Info(fmt.Sprintf("Template.Mappings string new: %s", request.Template.Mappings.String()))
	logger.Info(fmt.Sprintf("Template.Mappings string existing: %s", response.IndexTemplate.Template.Mappings.String()))
