...
func (r *IndexTemplateReconciler) equal(request *requests.IndexTemplate, response *responses.IndexTemplate) bool {
	...
	logger.Info(fmt.Sprintf("Template.Settings string: %v", cmp.Equal(request.Template.Settings.String(), response.IndexTemplate.Template.Settings.String(), cmpopts.EquateEmpty())))
